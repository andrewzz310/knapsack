...
class TestPyeasyga(unittest.TestCase):
    ...
    def setUp(self):
        ...
        member_1 = modifiedga.Chromosome([0, 1, 0, 1, 1])
        member_2 = modifiedga.Chromosome([1, 1, 0, 0, 1])
        member_3 = modifiedga.Chromosome([1, 1, 1, 1, 0])
        member_4 = modifiedga.Chromosome([0, 1, 1, 1, 1])
        ...
        self.ga = modifiedga.GeneticAlgorithm(self.seed_data)
    ...
    def test_genetic_algorithm_initialisation_1(self):
        ...
        ga_1 = modifiedga.GeneticAlgorithm(self.seed_data)
    ...
    def test_genetic_algorithm_initialisation_2(self):
        ...
        ga_2 = modifiedga.GeneticAlgorithm(self.seed_data,
                                           population_size=235,
                                           generations=57,
    ...
    def test_chromosome_initialisation_1(self):
        chromosome = modifiedga.Chromosome(['a', 'b', 'c'])
    ...
    def test_chromosome_initialisation_2(self):
        chromosome = modifiedga.Chromosome(['d', 'e', 'f'])
    ...
    def test_create_initial_population(self):
        ...
        assert isinstance(initial_pop[0], type(modifiedga.Chromosome([1])))
    ...
    def test_create_new_population(self):
        ...
        assert isinstance(current_gen[0], type(modifiedga.Chromosome([1])))
